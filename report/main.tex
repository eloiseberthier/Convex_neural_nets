...
\end{lemma}
The proof is straightforward: any Hilbert space $\mathcal{W}$ is convex, $ \ell(w \cdot \varphi(x_i), y_i)$ is convex in $w$ and by additivity the objective function also is.\\
